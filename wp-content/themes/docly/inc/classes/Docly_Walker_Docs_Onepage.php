 ...
 * weDocs Docs Walker
 */
class Docly_Walker_Docs_Onepage extends Walker_Page {
    /**
    ...
    public function start_el( &$output, $page, $depth = 0, $args = array(), $current_page = 0 ) {
        ...
        $thumb = '';
        if ( $depth == 0 ) {
            $folder = '<img src="' . DOCLY_DIR_IMG . '/folder-closed.png" alt="' . esc_attr__('folder icon closed', 'docly') . '"> <img src="' . DOCLY_DIR_IMG . '/folder-open.png" alt="' . esc_attr__('folder icon', 'docly') . '">';
