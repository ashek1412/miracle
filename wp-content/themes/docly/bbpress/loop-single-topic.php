    ...
    <div class="community-post style-two">
        <div class="post-content">
            ...
            <div class="entry-content">
                ...
                <ul class="meta">
                    <li>
                        <?php echo get_the_post_thumbnail(bbp_get_forum_id(), 'docly_18x18'); ?>
                        <a href="<?php bbp_forum_permalink(bbp_get_forum_id()); ?>">
                            <?php bbp_forum_title(bbp_get_forum_id()); ?>
                        </a>
                    </li>
                    <li><i class="icon_calendar"></i> <?php echo bbp_get_forum_last_active_time() ?> </li>
                </ul>
            </div>
        </div>
