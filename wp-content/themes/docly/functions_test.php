...
function addCustomer() {
  ...
  //$ch = curl_init('https://secure.fusebill.com/v1/Plans?query=status:Active&query=code:'.$planCode);
...
//    echo "<pre>";
//    print_r($result->subscriptionProducts[0]->id);
//    echo "</pre>";
//    exit;
...
//         exit;
    ...
    if(empty($result->billingAddress)) {
