...
Redux::disable_demo();
Redux::set_args( 'docly_opt', array( 'compiler_ouput_variables_prefix' => '@' ) );
...
$args = array(
	...
	'menu_title'           => esc_html__( 'Theme Settings', 'docly' ),
	'page_title'           => esc_html__( 'Docly Theme Settings', 'docly' ),
...
$args['footer_text'] = '<br>'.esc_html__( 'Copyright Docly &copy; 2019-2020', 'docly' );
