...
function wpfts_admin_menu()
{
	...
	// Add submenus
	add_submenu_page('wpfts-options', __('Main Configuration', 'fulltext-search'), __('Main Configuration', 'fulltext-search'), 'manage_options', 'wpfts-options', 'wpfts_option_page');
	add_submenu_page('wpfts-options', __('Indexing Engine Settings', 'fulltext-search'), __('Indexing Engine', 'fulltext-search'), 'manage_options', 'wpfts-options-indexing-engine', 'wpfts_option_page');
	add_submenu_page('wpfts-options', __('Search & Output', 'fulltext-search'), __('Search & Output', 'fulltext-search'), 'manage_options', 'wpfts-options-search-relevance', 'wpfts_option_page');
	add_submenu_page('wpfts-options', __('Sandbox Area', 'fulltext-search'), __('Sandbox Area', 'fulltext-search'), 'manage_options', 'wpfts-options-sandbox-area', 'wpfts_option_page');
	add_submenu_page('wpfts-options', __('Licensing', 'fulltext-search'), __('Licensing', 'fulltext-search'), 'manage_options', 'wpfts-options-licensing', 'wpfts_option_page');
